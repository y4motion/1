      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                ...
                {productImages.map((img, idx) => (
                  <button
                    ...
                    style={{
                      ...
                      overflow: 'hidden',
                      cursor: 'pointer',
                      border: selectedImage === idx ? '2px solid rgba(255, 255, 255, 0.3)' : '1px solid rgba(255, 255, 255, 0.05)',
                      padding: 0
                    }}
                  >
                    <img
        ...
        <div className="glass-subtle" style={{
          ...
          <div style={{
            ...
            <div>Status: <span className={`status-badge status-${product.status.split('_')[0]}`} style={{ marginLeft: '0.5rem' }}>{product.status}</span></div>
