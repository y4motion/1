...
import { ArrowLeft, Bell, Package, Heart, MessageCircle, Trophy, Gift, Check, X } from 'lucide-react';
  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      message: language === 'ru' ? 'Ваш заказ в пути. Ожидайте доставку 2-3 дня' : 'Your order is on the way. Expect delivery in 2-3 days',
      time: '5m',
      read: false
    },
    {
      ...
      message: language === 'ru' ? 'Кто-то добавил ваш товар "RTX 4090" в избранное' : 'Someone added your product "RTX 4090" to favorites',
      time: '1h',
      read: false
    },
    {
      ...
      message: language === 'ru' ? 'Support AI ответил на ваше сообщение' : 'Support AI replied to your message',
      time: '2h',
      read: true
    },
    {
      ...
      message: language === 'ru' ? 'Вы получили "Первая покупка" +50 XP' : 'You earned "First Purchase" +50 XP',
      time: '1d',
      read: true
    },
    {
              ...
              <div
                ...
                style={{
                  ...
                  background: notification.read
                    ? (theme === 'minimal-mod' ? 'rgba(0, 0, 0, 0.95)' : undefined)
                ...
                <div style={{ display: 'flex', gap: '0.5rem', flexShrink: 0 }}>
                  {!notification.read && (
                    <button
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.background = theme === 'dark' ? 'rgba(76, 175, 80, 0.1)' : 'rgba(76, 175, 80, 0.05)';
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background = 'transparent';
                      }}
          ...
          {notifications.length === 0 && (
            ...
            >
              ...
              <div style={{ fontSize: '0.875rem', opacity: 0.6 }}>
                {language === 'ru' ? 'Когда появятся новые уведомления, они будут здесь' : 'When you get notifications, they\'ll show up here'}
              </div>
            </div>
          )}
        </div>
