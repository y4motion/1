...
const UserProfilePage = () => {
  ...
  const [profileData, setProfileData] = useState(() => {
    ...
    return {
      ...
      bio:
        mockUser.bio ||
        (language === 'ru' ? 'Любитель игр и технологий' : 'Gaming and tech enthusiast'),
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '1.5rem', marginBottom: '1.5rem' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                ...
                <span
                  style={{ fontSize: '0.875rem', fontWeight: '700', color: currentLevel.color }}
                >
                  {currentLevel.name}
                </span>
                <span style={{ opacity: 0.7, fontSize: '0.875rem' }}>LVL {displayUser.level}</span>
              </div>
          ...
          {profileData.bio && (
            ...
            >
              <div style={{ fontSize: '0.9375rem', lineHeight: '1.6' }}>{profileData.bio}</div>
            </div>
          )}
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              {new Date(displayUser.joinedDate || '2024-01-01').toLocaleDateString(
        ...
        >
          ...
          <div>
            ...
            >
              <span>
                {displayUser.nextLevelXP - displayUser.xp} XP{' '}
                {language === 'ru' ? 'до следующего уровня' : 'to next level'}
              </span>
        ...
        >
          {[
            ...
            {
              id: 'achievements',
              label: language === 'ru' ? 'Достижения' : 'Achievements',
              icon: Trophy,
            },
          ...
          {activeTab === 'stats' && (
            ...
            >
              ...
              >
                ...
                <div style={{ fontSize: '0.75rem', opacity: 0.6 }}>
                  {language === 'ru' ? 'Квесты сегодня' : 'Quests Today'}
                </div>
              </div>
              <div
                className="glass-subtle"
              ...
              >
                <div style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>🪙</div>
                <div style={{ fontSize: '1.75rem', fontWeight: '700' }}>
                  {displayUser.bonusBalance}
                </div>
                <div style={{ fontSize: '0.75rem', opacity: 0.6 }}>
                  {language === 'ru' ? 'Бонусные монеты' : 'Bonus Coins'}
                </div>
              </div>
            </div>
          )}
