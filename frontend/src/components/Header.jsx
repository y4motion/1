...
const Header = () => {
  ...
  const navLinks = [
    ...
    { name: language === 'ru' ? 'СБОРОЧНАЯ' : language === 'advanced' ? 'ASSEMBLY' : 'ASSEMBLY', path: '/pc-builder', key: 'pc-builder' },
  ...
  return (
    <>
      {/* Spin Wheel Modal */}
      {showSpinWheel && <SpinWheel onClose={() => setShowSpinWheel(false)} onWin={handleSpinWin} />}
              ...
              {showSettingsMenu && (
                <div
                  ...
                  style={{
                    ...
                    border:
                      theme === 'minimal-mod' ? '1px solid rgba(241, 241, 241, 0.12)' : undefined,
                    padding: '0.875rem',
                    zIndex: 100,
                    fontFamily:
                      theme === 'minimal-mod'
                          ...
                          <button
                            ...
                            style={{
                              ...
                              border:
                                soundMode === mode
                                  ? theme === 'minimal-mod'
                                    ? '1px solid rgba(241, 241, 241, 0.3)'
                  ...
                  <div style={{ display: 'flex', gap: '0.75rem' }}>
                    ...
                    <div style={{ flex: '1' }}>
                      ...
                      >
                        {theme === 'dark' ? (
                          <>
                            <Sun size={14} className="icon-color" />
                            <span className="icon-color">
                          ...
                          <>
                            <Moon size={14} className="icon-color" />
                            <span className="icon-color">
                          ...
                          <>
                            <Power size={14} className="icon-color" />
                            <span className="icon-color">
                              {language === 'ru' ? 'Минимал Мод' : 'Minimal Mod'}
                            </span>
                          </>
                        )}
                      </button>
        ...
        >
            ...
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
              ...
              <BadgeTooltip
                content={
                  <div>
                    <div
                      style={{ fontWeight: '700', marginBottom: '0.5rem', fontSize: '0.9375rem' }}
                    >
                      {language === 'ru'
                    ...
                    <div style={{ fontSize: '0.75rem', opacity: 0.7, lineHeight: '1.6' }}>
                      • {language === 'ru' ? 'Эксклюзивные скидки' : 'Exclusive discounts'}
                      <br />• {language === 'ru' ? 'Особые награды' : 'Special rewards'}
                      <br />•{' '}
                      {language === 'ru'
                ...
                content={
                  <div>
                    ...
                    <div style={{ fontSize: '0.75rem', opacity: 0.7, lineHeight: '1.6' }}>
                      •{' '}
                      {language === 'ru'
                        ? 'Покупки: +10 XP за каждый $1'
                        : 'Purchases: +10 XP per $1'}
                      <br />•{' '}
                      {language === 'ru' ? 'Отзывы: +25 XP за отзыв' : 'Reviews: +25 XP per review'}
                      <br />• {language === 'ru' ? 'Ежедневный вход: +5 XP' : 'Daily login: +5 XP'}
                      <br />•{' '}
                      {language === 'ru' ? 'Реферальная программа: +100 XP' : 'Referrals: +100 XP'}
                      <br />•{' '}
              ...
              <BadgeTooltip
                content={
                  <div>
                    ...
                    <div style={{ fontSize: '0.75rem', opacity: 0.7, lineHeight: '1.6' }}>
                      • {language === 'ru' ? 'Выполняйте квесты' : 'Complete quests'}
                      <br />• {language === 'ru' ? 'Совершайте покупки' : 'Make purchases'}
                      <br />• {language === 'ru' ? 'Приглашайте друзей' : 'Invite friends'}
                    </div>
                    <div
                      style={{
                        marginTop: '0.5rem',
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    borderRadius: theme === 'minimal-mod' ? '0' : '12px',
                    background:
                      theme === 'dark' ? 'rgba(255, 215, 0, 0.15)' : 'rgba(255, 215, 0, 0.1)',
              ...
              <BadgeTooltip
                content={
                  <div>
                    ...
                    >
                      {language === 'ru'
                        ? `Серия входов: ${displayUser.loginStreak} дней 🔥`
                        : `Login streak: ${displayUser.loginStreak} days 🔥`}
                    </div>
                    <div style={{ marginBottom: '0.5rem', opacity: 0.8 }}>
                      {language === 'ru'
                    ...
                    <div style={{ fontSize: '0.75rem', opacity: 0.7, lineHeight: '1.6' }}>
                      {displayUser.loginStreak >= 7 ? '✅' : '🔒'} 7{' '}
                      {language === 'ru' ? 'дней: +50 XP бонус' : 'days: +50 XP bonus'}
                      <br />
                      {displayUser.loginStreak >= 14 ? '✅' : '🔒'} 14{' '}
                      {language === 'ru' ? 'дней: +150 XP + 100🪙' : 'days: +150 XP + 100🪙'}
                      <br />
                      {displayUser.loginStreak >= 30 ? '✅' : '🔒'} 30{' '}
                      {language === 'ru' ? 'дней: +500 XP + 500🪙' : 'days: +500 XP + 500🪙'}
                      <br />
                      {displayUser.loginStreak >= 100 ? '✅' : '🔒'} 100{' '}
                      {language === 'ru'
                        ? 'дней: Эпическое достижение!'
                        : 'days: Epic achievement!'}
                    </div>
                    <div
                      style={{
                        marginTop: '0.5rem',
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: theme === 'minimal-mod' ? '0' : '12px',
                    background:
                      theme === 'dark' ? 'rgba(255, 152, 0, 0.15)' : 'rgba(255, 152, 0, 0.1)',
              ...
              <BadgeTooltip
                content={
                  <div>
                    ...
                    >
                      • {language === 'ru' ? 'Скидки (1🪙 = $0.01)' : 'Discounts (1🪙 = $0.01)'}
                      <br />• {language === 'ru' ? 'Лутбоксы' : 'Lootboxes'}
                      <br />• {language === 'ru' ? 'Аукционы' : 'Auctions'}
                      <br />• {language === 'ru' ? 'Эксклюзивы' : 'Exclusive items'}
                    </div>
                    <div
                      style={{
                        fontSize: '0.75rem',
                    ...
                    <div style={{ fontSize: '0.75rem', opacity: 0.7, lineHeight: '1.6' }}>
                      • {language === 'ru' ? 'Квесты: +50-200🪙' : 'Quests: +50-200🪙'}
                      <br />• {language === 'ru' ? 'Покупки: +1🪙/$1' : 'Purchases: +1🪙/$1'}
                      <br />•{' '}
                      {language === 'ru' ? 'Колесо фортуны: до 1000🪙' : 'Spin wheel: up to 1000🪙'}
                      <br />• {language === 'ru' ? 'Рефералы: +500🪙' : 'Referrals: +500🪙'}
                    </div>
                    <div
                      style={{
                        marginTop: '0.5rem',
          ...
          <div style={{ padding: '0.5rem' }}>
            ...
            >
              <Users size={20} />
              <span style={{ fontSize: '0.9375rem', fontWeight: '500' }}>
                {language === 'ru' ? 'Сообщества' : 'Communities'}
              </span>
            </Link>
      ...
      {/* Quick Cart Panel */}
      <QuickCartPanel isOpen={showCartPanel} onClose={() => setShowCartPanel(false)} />
