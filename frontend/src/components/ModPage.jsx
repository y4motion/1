...
const ModPage = () => {
  ...
  const modCategories = [
    ...
    },
    {
      ...
      description:
        language === 'ru'
          ? 'RGB, кастомные панели, водяное охлаждение'
          : 'RGB, custom panels, water cooling',
    },
    {
      id: 'performance',
      ...
      description:
        language === 'ru'
          ? 'Разгон, обновление BIOS, оптимизация'
          : 'Overclocking, BIOS updates, optimization',
    },
    {
      id: 'cooling',
      ...
      description:
        language === 'ru'
          ? 'Кастомные петли, вентиляторы, термопасты'
          : 'Custom loops, fans, thermal compounds',
    },
    {
      id: 'protection',
      ...
      description:
        language === 'ru'
          ? 'Пылевые фильтры, защита от перенапряжения'
          : 'Dust filters, surge protection',
    },
  ];
  ...
  const modServices = [
    ...
    },
    {
      id: 'cable-management',
      name:
        language === 'ru' ? 'Профессиональная укладка кабелей' : 'Professional Cable Management',
      category: 'aesthetic',
      price: 89,
