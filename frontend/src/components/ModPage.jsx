    ...
    <div className={`mod-page temple ${isArmoryOpen ? 'armory-active' : ''} ${guardiansAwakened ? 'guardians-awakened' : ''}`} ref={containerRef}>
      ...
      <div className="guardians-layer">
        ...
        <motion.div 
          ...
          style={{ 
            rotateY: leftGuardianRotate,
            scale: guardiansScale,
          }}
          animate={{
            x: isArmoryOpen ? -200 : 0,
            opacity: isArmoryOpen ? 0.3 : 1,
          }}
          ...
          <div className="guardian-body">
            <div className="guardian-head">
              <motion.div 
                ...
                style={{ opacity: guardiansGlow }}
              />
            </div>
            <div className="guardian-torso">
              <div className="guardian-rune"></div>
              <div className="guardian-rune"></div>
              <div className="guardian-rune"></div>
            </div>
            <div className="guardian-arm guardian-arm-inner"></div>
            <div className="guardian-arm guardian-arm-outer"></div>
          </div>
          <div className="guardian-shadow"></div>
        </motion.div>
        ...
        {/* Guardian Glow Effect when awakened */}
        <motion.div 
          className="guardians-awareness"
          animate={{ opacity: guardiansAwakened ? 1 : 0 }}
