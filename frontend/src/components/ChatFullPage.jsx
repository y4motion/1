...
import { Send, ArrowLeft, Settings, Bot, User as UserIcon, Paperclip, Image as ImageIcon, Smile } from 'lucide-react';
...
const ChatFullPage = () => {
  ...
  const [messages, setMessages] = useState([
    ...
    },
    {
      id: 2,
      sender: 'user',
      text: language === 'ru' ? 'Расскажите о ваших топовых видеокартах' : 'Tell me about your top GPUs',
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Messages Area */}
        <div
          className={theme === 'minimal-mod' ? 'catalog-content-scroll' : 'glass catalog-content-scroll'}
          style={{
            flex: 1,
            padding: '1.5rem',
            borderRadius: theme === 'minimal-mod' ? '0' : '16px',
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-end' }}>
            ...
            <button
              ...
              style={{
                ...
                background: inputMessage.trim() ? 'linear-gradient(135deg, #8b5cf6 0%, #6366f1 100%)' : 'rgba(139, 92, 246, 0.3)',
                border: 'none',
                borderRadius: theme === 'minimal-mod' ? '0' : '12px',
