export const translations = {
  ...
  ru: {
    ...
    pcBuilder: {
      title: 'СБОРОЧНАЯ ПК',
      subtitle: 'Создайте идеальную конфигурацию для игр и работы',
      case: 'КОРПУС',
      cpu: 'ПРОЦЕССОР',
      gpu: 'ВИДЕОКАРТА',
      ...
      psu: 'БЛОК ПИТАНИЯ',
      cooling: 'ОХЛАЖДЕНИЕ',
      selectComponent: 'Выбрать',
      compatibility: 'Совместимость',
      powerCalculator: 'РАСЧЁТ МОЩНОСТИ',
      consumption: 'Потребление',
      recommended: 'Рекомендуемый БП',
      summary: 'ИТОГО',
      components: 'Компонентов',
      total: 'Всего',
      addToCart: 'В КОРЗИНУ',
      orderAssembled: 'ЗАКАЗАТЬ СБОРКУ',
      smartFilter: 'Умный фильтр',
    },
    swap: {
      title: 'GLASSY SWAP',
      subtitle: 'Обменяй, улучши или найди железо среди энтузиастов',
      searchPlaceholder: 'Поиск RTX 4090, обмен, Москва...',
      ...
      tradePreferences: 'Предпочтения по обмену',
      message: 'Написать',
      share: 'Поделиться',
      ...
      photos: 'Фотографии',
      dragPhotos: 'Перетащите фото или нажмите для выбора',
      maxPhotos: 'До 5 фото, макс 10MB каждое',
      orPasteUrl: 'или вставьте ссылку',
      main: 'Главное',
      priceLabel: 'Цена ₽',
      location: 'Город',
      descriptionLabel: 'Описание',
      openToTrade: 'Готов к обмену',
      allSet: 'Всё готово!',
      clickPublish: 'Нажмите "Опубликовать" для создания объявления',
      next: 'Далее',
      publish: 'Опубликовать',
      // Empty state
      nothingYet: 'Пока пусто',
      beFirst: 'Будь первым, кто выставит своё железо',
      noListings: 'Объявления не найдены',
      // AI tips
      aiTip1: 'Правильная категория увеличивает просмотры на 60%',
      aiTip2: 'Объявления с 3+ фото продаются на 40% быстрее',
      aiTip3: 'Подробное описание повышает доверие покупателей',
      aiTip4: 'Отличная работа! Объявление готово к публикации',
      // Chat
      messageSeller: 'Написать продавцу',
      askAboutItem: 'Задайте вопрос о товаре или предложите сделку',
      quickMessages: 'Быстрые сообщения:',
      stillAvailable: '🔍 Ещё в наличии?',
      lowestPrice: '💰 Минимальная цена?',
      offerTrade: '🔄 Предложить обмен',
      noMessages: 'Нет сообщений',
      startChatPrompt: 'Начните чат с продавцом на странице любого объявления в Glassy Swap!',
      chatWithSeller: 'Чат с продавцом',
      startConversation: 'Начните диалог с продавцом',
    },
  },
  advanced: {
